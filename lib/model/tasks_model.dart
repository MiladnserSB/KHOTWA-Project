...
class TasksModel {
    ...
    factory TasksModel.fromJson(Map<String, dynamic> json) => TasksModel(
        ...
        data: List<TaskModel>.from(json["data"].map((x) => TaskModel.fromJson(x))),
    );
...
class TaskModel {
    ...
    factory TaskModel.fromJson(Map<String, dynamic> json) => TaskModel(
        ...
        startDate: json["start_date"] != null ? DateTime.parse(json["start_date"]) : null, // Handle nullable startDate
    ...
    Map<String, dynamic> toJson() => {
        ...
        "start_date": startDate?.toIso8601String(), // Use ISO 8601 format if not null
