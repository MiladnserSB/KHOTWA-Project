...
class MapScreenChooseLocation extends StatefulWidget {
  ...
  final void Function(PickedData pickedData)
  onPicked; // لارجاع الاحداثيات المخنارة (خط الطول و خط العرض)

  final Future<LatLng> Function()
  onGetCurrentLocationPressed; // مسان تحديد الموقع التلقائي
...
class _MapScreenChooseLocationState extends State<MapScreenChooseLocation> {
  ...
  final TextEditingController _searchController =
      TextEditingController(); // لتخزنوا فيه العنوان كإسم و وصف يعني
  ...
  void initState() {
    ...
    _mapController.mapEventStream.listen((event) async {
      if (event is MapEventMoveEnd) {
        ...
        final headers = {'User-Agent': "${deviceModel}3"};
      ...
      children: [
          ...
          child: FlutterMap(
            options: MapOptions(
              ...
              maxBounds: LatLngBounds(
                LatLng(27.1401861, 31.5494106),
                LatLng(42.1401861, 46.5494106),
              ),
            ),
        ...
        Positioned(
          ...
          child: FloatingActionButton(
            ...
            child: Icon(Icons.my_location, color: widget.buttonTextColor),
          ),
        ),
        Positioned(
                    ...
                    _debounce = Timer(
                      ...
                      () async {
                        ...
                        try {
                          ...
                          final headers = {'User-Agent': "${deviceModel}6"};
                          ...
                          _options = tempOptions
                              .where(
                                (element) => element.displayName.contains(
                                  widget.limitLocation,
                                ),
                              )
                              .toList();
                          setState(() {});
  ...
  void setNameCurrentPos() async {
    ...
    final headers = {'User-Agent': deviceModel};
    String url =
